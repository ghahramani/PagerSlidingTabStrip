...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabAlignment = Gravity.LEFT;
    private int dividerWidth = 1;

    private float tabTextSize = 12;
    private int tabTextUnit = TypedValue.COMPLEX_UNIT_PX;
    ...
    private Integer tabBackgroundColor = null;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setGravity(tabAlignment);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                String text = String.valueOf(pager.getAdapter().getPageTitle(i));
    ...
    private void addTextTab(final int position) {
        ...
        tabsContainer.addView(tab, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextSize(tabTextUnit, tabTextSize);
...
//        updateTabStyles();
    ...
    public void setTextSize(float textSizePx) {
        ...
        this.tabTextUnit = TypedValue.COMPLEX_UNIT_PX;
        updateTabStyles();
    }

    public void setTextSize(int unit, float size) {
        this.tabTextSize = size;
        this.tabTextUnit = unit;
        updateTabStyles();
    }
    ...
    public void setTabAlignment(int alignment) {
        ...
        tabsContainer.setGravity(alignment);
    }
